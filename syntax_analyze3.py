...
def p_struct_dec(p):
    ...
    p[0] = Node("struct_dec", [p[4], p[5], p[7]], [p[1], p[2], p[3], p[6]])
...
def p_id_array_const2_more(p):
    ...
    p[0] = Node("id_array_const2", [p[2], p[3]], p[1])
...
def p_assignment_operators(p):
    '''assignment_operators : plus_equal
                            ...
                            | modulo_equal
                            | times_times_equal'''
    p[0] = Node("assignment_operators", [], p[1])
...
def p_control_statements(p):
    '''control_statements : Break
                        | Continue
                        | Avoid'''
    p[0] = Node("control_statements", [], p[1])
...
def p_relational_operators(p):
    ''' relational_operators    : greater_than
                                ...
                                | great_than_equal
                                | less_than_equal'''
    p[0] = Node("relational_operators", [], p[1])
...
def p_logical_operators(p):
    ''' logical_operators   : And
                            | Or'''
    p[0] = Node("logical_operators", [], p[1])
